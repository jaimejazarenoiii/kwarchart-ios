...
public struct ChartSample {
    public static let pieSeriesSample = [ PieSeries(data: ChartData(key: "String", value: 100.0), color: .blue, legend: "String"),
                                 ...
                                 PieSeries(data: ChartData(key: " ", value: 100), color: .orange, legend: "String3")]
    
    public static let pieChartViewSample = PieChartView(dataModel: PieChartDataModel.init(dataModel: ChartSample.pieSeriesSample))
}
